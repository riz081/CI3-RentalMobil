            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="dropdown"><a href="#" class="nav-link nav-link-lg nav-link-user">
                            <div class="d-sm-none d-lg-inline-block"><i class="fa fa-lg fa-user mr-2"></i> Hi, <?php echo $this->session->userdata('nama_admin') ?></div>
                        </a>
                    </li>
                </ul>
            </nav>
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="index.html">Rental Mobil APPS</a>
                    </div>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li><a class="nav-link" href="<?php echo base_url('admin/register_admin') ?>"><i class="fas fa-user-cog"></i><span>Registrasi Admin</span></a></li>
                        ...
                        <li><a class="nav-link" href="<?php echo base_url('admin/data_driver') ?>"><i class="fas fa-user-clock"></i> <span>Data Driver</span></a></li>
                        ...
                        <li><a class="nav-link" href="<?php echo base_url('admin/auth_admin/ganti_password') ?>"><i class="fas fa-lock"></i> <span>Ganti Password</span></a></li>
                        <li><a class="nav-link" href="<?php echo base_url('admin/auth_admin/logout') ?>"><i class="fas fa-sign-out-alt"></i> <span>Logout</span></a></li>
                    </ul>
                </aside>
            </div>