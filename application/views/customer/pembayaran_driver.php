    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card" style="margin-top: 150px;">
                ...
                <div class="card-body">
                    <table class="table">
                        <?php foreach ($transaksi_driver as $tr) : ?>
                            <tr>
                                <th>Nickname</th>
                                <td>:</td>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td><?php echo number_format($tr->harga_driver, 0, ',', '.') ?></td>
                            </tr>
                            ...
                            <tr class="text-success">
                                ...
                                <td><button class="btn btn-sm btn-success"> Rp.
                                        <?php echo number_format($tr->harga_driver * $jml_hari, 0, ',', '.') ?>
                                    </button>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                <td></td>
                                <td><a href="<?php echo base_url('customer/transaksi_driver/cetak_invoice/' . $tr->id_rental) ?>" class="btn btn-sm btn-secondary">Print Invoice</a></td>
                            </tr>
                        <?php endforeach; ?>
                    </table>
                </div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url('customer/transaksi_driver/pembayaran_aksi') ?>" enctype="multipart/form-data" method="POST">
