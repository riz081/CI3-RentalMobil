<div class="main-content">
    ...
    <?php foreach ($transaksi_driver as $tr) : ?>
        <form action="<?php echo base_url('admin/transaksi_driver/transaksi_selesai_aksi') ?>" method="POST">
            ...
            <input type="hidden" name="denda_driver" value="<?php echo $tr->denda_driver ?>">
